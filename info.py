...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5505349428').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001882933789').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
auth_channel = environ.get('AUTH_CHANNEL', '-1001980945493')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001451111323')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001951457924')
...
VERIFY2_API = environ.get('VERIFY2_API', "c75fabf7a6d56f15d49fa81c4bb49c06dda52182")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'omegalinks.in')
SHORTLINK_API = environ.get('SHORTLINK_API', 'c75fabf7a6d56f15d49fa81c4bb49c06dda52182')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001983235152'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'DQSupport')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001989601340')).split()]
